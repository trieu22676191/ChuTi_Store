...
const DieuKhoan = () => (
  <Container className="py-4">
    ...
    <div style={{ textAlign: "justify", fontSize: 16 }}>
      ...
      tư cách khách viếng thăm hay thành viên đã đăng ký, xin vui lòng đọc kỹ
      quy định sử dụng. ChuTi có quyền thay đổi, chỉnh sửa, thêm hoặc lược bỏ
      bất kỳ phần nào trong Điều khoản sử dụng này, vào bất cứ lúc nào. Các thay
      đổi có hiệu lực ngay khi được đăng trên Website{" "}
      <span style={{ color: "#2eaf74", fontWeight: 600 }}>ChuTi Beaty</span> mà
      không cần thông báo trước và quý khách có trách nhiệm phải cập nhật
      Website{" "}
      ...
      <span style={{ color: "#2eaf74", fontWeight: 600 }}>ChuTi Beaty</span> sau
      khi những thay đổi đó được đăng đồng nghĩa với việc bạn đã đồng ý với
      những sửa đổi trong Quy định sử dụng
      <br />
      <br />
      ChuTi không chịu trách nhiệm về chất lượng đường truyền Internet ảnh hưởng
      đến tốc độ truy cập của bạn vào Website{" "}
      <span style={{ color: "#2eaf74", fontWeight: 600 }}>ChuTi Beaty</span>.
    </div>
